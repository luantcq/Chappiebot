package com.example.chappiebot;
...
import com.example.chappiebot.base.AppConstants;
import com.example.chappiebot.base.BaseFragment;
import com.example.chappiebot.ui.main.FeedsFragment;

import java.util.HashMap;
import java.util.Stack;

public class MainActivity extends AppCompatActivity implements BaseFragment.OnFragmentAttachedListener {
    /* Your Tab host */
        ...
        public void onTabChanged(String tabId) {
            ...
            if (mStacks.get(tabId).size() == 0) {
                ...
                if (tabId.equals(AppConstants.TAB_A)) {
                    pushFragments(tabId, new FeedsFragment(), false,
                            true);
